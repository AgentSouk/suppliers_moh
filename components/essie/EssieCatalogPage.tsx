      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 pt-2 pb-0">
          <div className="text-xs text-gray-400">
            <a href="/suppliers" className="hover:underline text-red-500">Suppliers</a>
            <span className="mx-1">›</span><span>Essie</span>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500"
