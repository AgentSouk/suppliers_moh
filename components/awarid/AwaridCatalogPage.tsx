...
function generateOrderNumber() {
  ...
  return `AW-${d.getFullYear()}${pad(d.getMonth()+1)}${pad(d.getDate())}-${pad(d.getHours())}${pad(d.getMinutes())}`;
}


export default function AwaridCatalogPage() {
  ...
  const { cart, setCart, location, setLocation, orderHistory, cartTotals,
    removeFromCart, updateQuantity, clearCart, saveToHistory, clearHistory } = useCart("awarid");
  ...
  const generateExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Awarid Order");
  ...
  return (
    <div className="min-h-screen" style={{ background: colors.contentBg }}>
      ...
      <div className="px-6 pt-3 pb-1 text-xs bg-white/70 border-b border-amber-50" style={{ color: colors.textMuted }}>
        ...
        <span className="mx-1">›</span><span>Awarid</span>
      </div>
      ...
      <div className="px-6 py-4 bg-white/80 backdrop-blur border-b border-amber-50 shadow-sm sticky top-0 z-40">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            <img src="/logos/awarid.png" alt="Awarid" className="h-8 object-contain" onError={e => (e.target as HTMLImageElement).style.display='none'} />
            <div>
              <h1 className="text-lg font-bold text-gray-900">Awarid Catalogue</h1>
                    ...
                    {product.photo ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                        <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: "#fef3c7" }}>
                          <span className="text-lg font-bold" style={{ color: colors.primary }}>AW</span>
                        </div>
          ...
          <div className="relative w-full max-w-lg h-full overflow-y-auto bg-white flex flex-col">
            <div className="sticky top-0 px-6 py-4 flex items-center justify-between bg-white border-b border-amber-50">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-gray-900">Cart · Awarid</h2>
            ...
            {!showHistory && cart.length > 0 && (
              <div className="sticky bottom-0 p-6 border-t bg-white">
                ...
                <ShareCartButton cart={cart} location={location} supplierId="awarid" supplierLabel="Awarid" />
