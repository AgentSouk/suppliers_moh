      ...
      <div className="px-6 py-4 bg-white/80 backdrop-blur border-b border-blue-50 shadow-sm sticky top-0 z-40">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            <img src="/logos/nazih.png" alt="Nazih" className="h-8 object-contain" onError={e => (e.target as HTMLImageElement).style.display='none'} />
            <div>
              <h1 className="text-lg font-bold text-gray-900">Nazih Catalogue</h1>
        ...
        <div className="relative max-w-sm">
          ...
          <input className="w-full pl-9 pr-4 py-2 border border-blue-100 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-400"
