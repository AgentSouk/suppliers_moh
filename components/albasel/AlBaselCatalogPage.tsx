      ...
      <div className="px-6 py-4 bg-white/80 backdrop-blur border-b border-yellow-50 shadow-sm sticky top-0 z-40">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xs sm:text-lg font-bold text-gray-900">Al Basel Cosmetics Catalogue</h1>
        ...
        <div className="relative max-w-sm">
          ...
          <input className="w-full pl-9 pr-4 py-2 border border-yellow-100 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
